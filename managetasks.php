                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_tasks.php?editid=<?php echo $row['id']; ?>" class="edit" title="Edit"
                                    data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                <a href="deletetasks.php?delid=<?php echo ($row['id']);?>" class="delete" title="Delete"
                        ...
                        <tr>
                            <th style="text-align:center; color:red;" colspan="6">No Task Added </th>
                        </tr>
                        <?php } ?>
